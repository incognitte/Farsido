 ...
 *
 * Konservo-Þlosilo-Dialogo - Æi tiu dialogo petas kriptigan þlosilon, por
...
public class SaveKeyDialog extends JDialog implements ActionListener {
   ...
   private final static int d_width  = 320;   // dialog width   -  dialoga larøeco
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if (command.equals("ok")) {
         ...
         // La þlosila teksto kaj la konfirma teksto devas esti
